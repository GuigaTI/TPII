...
public class ConsomeAPI {
    ...
    private static final String API_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyC9fAJ6KxSIOSzG1Gn0VfWKGcp2qkIVcx0";
    ...
    private static String enviarRequisicao(String jsonRequest) throws IOException, InterruptedException {
       ...
       HttpResponse<String> response = client.send(request, HttpResponse.BodyHandlers.ofString());
        ...
        if(response.statusCode() != 200){
            throw new IOException("Erro ao acessar a API" + response.statusCode());
        }
